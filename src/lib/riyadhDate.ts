...
/** "YYYY-MM-DD" لليوم التقويمي بتوقيت الرياض للحظة زمنية مُعطاة — تُستخدَم لمقارنة تاريخين بيوم
 * تقويمي سعودي واحد (مثلاً "تاريخ إشعار الدائن لا يسبق تاريخ الفاتورة الأصلية") بدل مقارنة
 * الطابعين الزمنيين UTC مباشرةً؛ مقارنة الطوابع الخام تكسر عند فاتورة/مستند مُسجَّل بتوقيت متأخر
 * من نفس اليوم السعودي (كالساعة 23:30) مقابل آخر بتوقيت مبكر UTC من نفس اليوم (كمنتصف الليل UTC،
 * أي الساعة 03:00 صباحاً بتوقيت الرياض من نفس اليوم بالضبط) — كلاهما نفس اليوم السعودي فعلياً رغم
 * اختلاف طابعيهما UTC. */
export function riyadhCalendarDay(instant: Date): string {
