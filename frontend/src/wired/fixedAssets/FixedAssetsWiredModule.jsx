...
export default function FixedAssetsWiredModule({ companies, companyId }) {
  const { t } = useTranslation();
  const [tab] = useModuleTab("/fixedAssets", FIXED_ASSETS_TABS);
  return (
    <div>
      ...
      <SubTabs tabs={FIXED_ASSETS_TABS} active={tab} basePath="/fixedAssets" />
