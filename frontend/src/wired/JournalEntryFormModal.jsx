 ...
 * للمتصفح لأول اختصار).
 */
export default function JournalEntryFormModal({ companyId, companies, accounts, costCenters, departments, branches, editingEntry, duplicateEntry, onClose, onSaved }) {
